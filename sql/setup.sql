...
(4, 'You come accross a meadow and se a fairy ring of mushrooms. Your Termagotchi immediately runs up to it and starts eating it.', 'It''s been awhile since your last trip. What the heck, join them and eat yo shrooms', 'Scold them and express your disapointment. Good digital pets don''t do drugs!', 17, 9),
(5, 'You come accross a shimmering orb. Nearly blinded by it''s light, you step closer to inspect', 'You step through what appears to be a portal. You are always down for an adventure', 'Your phone rings and as you answer you walk away, turning your back to the orb', 12, 18),
...
(23, 'The trip wasn''t as planned but it has brought you closer. You realize your love for eachother and you are bonded for life.', 'replay', 'exit', 1, 0),
(24, 'A kind stranger that happens to be your Termagotchi''s second cousins uncle finds them and by fate, brings them to their original family. As they are nutured back to health, they decide to stay with their family in Tokyo. You have lost your Termagotchi!', 'replay', 'exit', 1, 0),
...
(27, 'After hours of vomitting your Termagotchi feels better and finds the quickest escape through the crack in the door you left open. Your toxic energy was no environment to thrive in. You have lost your Termagotchi', 'replay', 'exit', 1, 0),
